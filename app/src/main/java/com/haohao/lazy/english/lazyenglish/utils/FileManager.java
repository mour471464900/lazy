...
public class FileManager{
    ...
    public static final File screenRecordCache;// 图片缓存目录

    static {
        appFile = new File(Environment.getExternalStorageDirectory(), "lazy");
        ...
        screenRecordCache = new File(appFile, "screenRecord");
        fileMkdirs(appFile,appImageCache, appDownload,appCache,screenRecordCache);
    }
...
//				UtilsToast.toastShort(R.string.down_file_del);
